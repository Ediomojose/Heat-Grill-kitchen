    ...
    <>
      <section className={` px-5 md:px-48 py-16`}>
        <div className={`py-4 md:py-8 flex flex-col gap-3 justify-center items-center`}>
          <h2 className={` text-3xl md:text-5xl font-playFairBlack text-brandBrown drop-shadow-2xl`}>Our Menu</h2>
          <p className={`text-center text-base md:text-lg font-filmNoirRegular`}>

...
const OrderForm = ({ onSubmit }: Props) => {
  ...
  return (
    <aside className={`px-5  md-px-0 flex flex-col justify-center items-center bg-brandLightBrown py-10 md:py-16`}>
        <h1 className={`text-3xl md:text-4xl font-CirkaBold `}>Book a Table Now!</h1>
        <p className={`text-center font-InterRegular pt-2 text-xs md:text-sm`}>
    ...
    <form
      onSubmit={handleSubmit((data) => {
        onSubmit(data);
        reset();
      })} className={`w-full md:w-1/2 lg:w-1/3 flex flex-col justify-center gap-2 py-10 font-CirkaBold`}
    >
      <div className={`flex flex-col gap-1`}>
        ...
        {errors.cusomerName && <small className={`p-2 bg-red-300 text-red-800 font-bold text-xs ease-in duration-300`}>{errors.cusomerName.message}</small>}
      </div>
      <div className={`flex flex-col gap-1`}>
        ...
        {errors.dishName && <small className={`p-2 bg-red-300 text-red-800 font-bold text-xs ease-in duration-300`}>{errors.dishName.message}</small>}
      </div>
      <div className={`flex flex-col gap-1`}>
        ...
        {errors.numberOrder && <small className={`p-2 bg-red-300 text-red-800 font-bold text-xs ease-in duration-300`}>{errors.numberOrder.message}</small> }
      </div>
